...
func NewNetworkResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbird:provider:NetworkResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkResource(ctx *pulumi.Context,
	...
	var resource NetworkResource
	err := ctx.ReadResource("netbird:provider:NetworkResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
