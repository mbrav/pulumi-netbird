module github.com/mbrav/pulumi-netbird

go 1.25.8

require (
	github.com/netbirdio/netbird v0.72.0
...
// )
// Netbird uses a fork of dex; replace directives from dependencies don't
// propagate, so we must mirror them here to satisfy the module graph.
replace (
