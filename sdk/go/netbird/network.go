...
type Network struct {
	...
	NetbirdId   pulumi.StringOutput `pulumi:"netbirdId"`
}
...
func (o NetworkOutput) NetbirdId() pulumi.StringOutput {
	return o.ApplyT(func(v *Network) pulumi.StringOutput { return v.NetbirdId }).(pulumi.StringOutput)
}
