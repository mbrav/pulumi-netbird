...
```bash
pulumi plugin install resource netbird 0.5.8 --server github://api.github.com/mbrav/pulumi-netbird
````
...
```bash
github.com/mbrav/pulumi-netbird/sdk v0.3.6 v0.3.7 v0.3.8 v0.4.1 v0.5.0 v0.5.1 v0.5.2 v0.5.3 v0.5.4 v0.5.5 v0.5.6 v0.5.7 v0.5.8 # ... and so on
```
...
```bash
pip install sdk/python/bin/dist/pulumi_netbird-0.5.8.tar.gz
```
